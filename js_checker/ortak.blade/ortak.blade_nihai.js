document.addEventListener("DOMContentLoaded", function() {
  ...
  MainPage.MobileTitleScreen.prototype = {
    preload: function() {
      core.load.crossOrigin = "anonymous";
      core.load.image(
        "icon",
    ...
    drawLayout: function(count) {
      for (let i = 0; i < count; i++) {
        ...
        const graphics = core.add.graphics(0, 0);
        ...
        // Görsel
        const image = core.add.image(0, 0, "icon");
        image.anchor.set(0.5);
        this.images.push(image);

        // Yazı
        const label = core.add.text(0, 0, "📱 Mobile View", {
          font: "20px Arial",
          fill: "#ffffff",
          align: "center",
          wordWrap: true,
    ...
    resize: function() {
      ...
      for (let i = 0; i < 10; i++) {
        ...
        // Görsel
        const img = core.add.image(x + cellW / 2, y + cellH / 2, "icon");
        img.anchor.set(0.5);
        ...
        // Yazı
        const label = core.add.text(img.x, img.y, "📱 Mobile View", {
          font: "20px Arial",
          fill: "#ffffff",
          align: "center",
          wordWrap: true,
